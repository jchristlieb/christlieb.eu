<template>
    <div>
        <div v-if="loading" class="text-center text-grey-dark pt-8">
            <svg class="fill-current h-24 w-24 spinning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div v-else>
            <div class="flex mb-4 pb-4 border-b border-grey">
                    ...
                    <div class="px-2 h-full">
                        ...
                        <div v-else class="flex items-center h-full">
                            <div class="self-center mx-auto">
                                <p>Select an image to see further infos</p></div>
                        </div>
                    </div>
                </div>
            </div>
